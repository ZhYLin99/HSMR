...
def read_image(file_name, format=None):
    ...
    with PathManager.open(file_name, "rb") as f:
        image = Image.open(f)
        # print("data_util>read_image, file", file_name)
        # print("data_util>read_image, img shape", image.size)
        ...
        # print("data_utils: read_image, image shape ", image.size)
...
# def read_gray_image(file_name, format=None):
#     with PathManager.open(file_name, "rb") as f:
#         image = Image.open(f)
#         # print("data_utils: read_gray_image, image shape ", image.size)
#         image = np.asarray(image)
#         # print("data_utils: read_gray_image, image shape ", image.size)
#         # image = np.expand_dims(image, -1)
#         image = np.repeat(image[..., np.newaxis], 3, axis=-1)
